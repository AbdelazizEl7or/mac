...
let rootUrl = URL(string: "https://elder-century-adjacent-enhance.trycloudflare.com")!

// allowed origin is for what we are sticking to pwa domain
// This should also appear in Info.plist
let allowedOrigins: [String] = ["elder-century-adjacent-enhance.trycloudflare.com"]

// auth origins will open in modal and show toolbar for back into the main origin.
// These should also appear in Info.plist
let authOrigins: [String] = ["elder-century-adjacent-enhance.trycloudflare.com"]
